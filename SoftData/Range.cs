...
namespace InfoLib.SoftData // THIS NAMESPACE IS A PRIMITIVE!  use only System.* or InfoLib.Testing references
{
    ...
    public class Range
    {
        ...
        public Range(double lowest, double highest, bool lowInclusive, bool highIncusive) { Init(lowest, highest, lowInclusive, highIncusive); }
        ...
        public double Middle { get { return Lowest + (Length / 2.0); } }
