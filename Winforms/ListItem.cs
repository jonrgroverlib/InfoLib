...
namespace InfoLib.Winforms
{
    ...
    public class ListItem : IListData
    {
        ...
        //  Constructors
        // ----------------------------------------------------------------------------------------
        public ListItem()                                                     { _id = "";               _descr = ""   ; }
        public ListItem(string id, string descr)                              { _id = id;               _descr = descr; }
        public ListItem(string id, string code, string descr)                 { _id = id; _code = code; _descr = descr; }
        public ListItem(string id, string code, string descr, string display) { _id = id; _code = code; _descr = descr; _display = display; }
