...
/* d */ public Endeme EnTarget     { get; set; }
        public string Pattern      { get { return EnTarget; } } // derived
...
/* d */ public int    HighCount    { get; set; } // hi logic value
    ...
    public class OrderFactor : IEndemeActuatorFactor
    {
        ...
        public Endeme EnTarget     { get { return new Endeme(Pattern, false);       } } // derived
        ...
        internal bool FoundInProfile(EndemeProfile profile)
        {
            ...
            {
                if (Regex.IsMatch(segment.ItemEndeme, pattern))
                    found = true;
            }
            return found;
        }
