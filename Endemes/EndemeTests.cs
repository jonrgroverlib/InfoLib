...
namespace InfoLib.Endemes // THIS NAMESPACE IS A PRIMITIVE!  use only System.* or InfoLib.Testing references
{
    ...
    public class EndemeTests
    {
        ...
        private void Endeme_CharAccessor_test()
        {
            ...
            Endeme en = new Endeme(Fruits, "ABCQ", false);
        ...
        private void Endeme_ShiftedMatch_test()
        {
            ...
            Endeme en1 = new Endeme(Fruits, "A"                     , false);
            Endeme en2 = new Endeme(Fruits, "B"                     , false);
            Endeme en3 = new Endeme(Fruits, "AB"                    , false);
            Endeme en4 = new Endeme(Fruits, "BA"                    , false);
            Endeme en5 = new Endeme(Fruits, "ABC"                   , false);
            Endeme en6 = new Endeme(Fruits, "DEF"                   , false);
            Endeme en7 = new Endeme(Fruits, "ABCDEFGHIJKLMNOPQRSTUV", false);
            Endeme en8 = new Endeme(Fruits, "VUTSRQPONMLKJIHGFEDCBA", false);
            Endeme en9 = new Endeme(Fruits, "ABCDEF"                , false);
        ...
        public void Endeme_Accesssor_test()
        {
            ...
            Endeme en = new Endeme(WetlandAnimals, "ABCDEFGHIJKLMNOPQRSTUV", false);
        ...
        public void Endeme_AddOperator_test()
        {
            ...
            Endeme e1 = new Endeme(WetlandAnimals, "ABCD", false);
            Endeme e2 = new Endeme(WetlandAnimals, "CDEF", false);
            Endeme e3 = e1 + e2;
        ...
        public void Endeme_AddToLetter_test()
        {
            ...
            Endeme en = new Endeme(WetlandAnimals, "", false);
            en.Plus('A', 4);
            en.Plus('B', 3);
            en.Plus('C', 7);
            en.Plus('D', 5);
        ...
        public void Endeme_Bag_test()
        {
            ...
            Endeme endeme = new Endeme(WetlandAnimals, "RPIQLTSJAOUDBCFEHNKVMG", false);
            EndemeGrabBag bag;
        ...
        {
            Endeme en1 = new Endeme(WetlandAnimals, endeme1, false);
            Endeme en2 = new Endeme(WetlandAnimals, endeme2, false);
            Endeme en3 = en1 & en2;
            Assert.That(en3, Is.equal_to, new Endeme(WetlandAnimals, tgt, false));
        }
        ...
        private static void Endeme_BuildString_testcase(EndemeSet wetlandAnimals)
        {
            ...
            Endeme e = new Endeme(wetlandAnimals, false);
        ...
        {
            Endeme en   = new Endeme(endeme, false);
            int eLength = en.ToCharArray().Length;
        ...
        {
            Endeme en = new Endeme(set, endeme, false);
            int eLength = en.ToCharArray().Length;
            Assert.That(eLength, Is.equal_to, length);
            string str = en;
            Assert.That(str, Is.equal_to, target);
        ...
        public void Endeme_Contains_test()
        {
            ...
            Endeme en = new Endeme("ABC", false);
        ...
        {
            Endeme en1 = new Endeme(WetlandAnimals, endeme, false);
            Endeme en2 = en1.Copy();
        ...
        public void Endeme_Count_test()
        {
            ...
            Endeme en = new Endeme(WetlandAnimals, "ABQNOPD", false);
        ...
        {
            Endeme en1 = new Endeme(WetlandAnimals, lhs, false);
            Endeme en2 = new Endeme(WetlandAnimals, rhs, false);
            Endeme en3 = en1 * en2;
        ...
        private static void AddMatch_testcase(Dictionary<string, EndemeTestItem> test, string name, double f1, double f2, double f3, double f4)
        {
            ...
            int LD12 = LevenshteinDistance(endeme1, endeme2);
            int LD13 = LevenshteinDistance(endeme1, e3);
            int LD23 = LevenshteinDistance(endeme2, e3);

            //int d1b = __.SimpleDistance(e3, endeme1);
            //int d2b = __.SimpleDistance(e3, endeme2);
            ...
            //string measures = endeme1 + "\t" + endeme2 + "\t" + e3
            //    + "\t" + d12 + "\t" + d13 + "\t" + d23
            //    + "\t" + c1 + "\t" + c2 + "\t" + c3
            //    + "\t" + zeroto1 + "\t" + output;
        ...
        {
	        double dist = 100.0 - LevenshteinDistance(endeme1, endeme2);
	        return dist;
        }
        ...
        //            + "  '" + (val.Endeme1 + "'").PadLeft(25) + " v '" + val.Endeme2 + "'";
        //    }
        ...
        public void EndemeActuator_HasChars_test()
        {
          ...
          //r = Assert.That(defn["Fruit:ABCD+Animal:ABCD"].Item.CharValue, Is.equal_to, 's');
            ...
            // --------------------------------------------------------------------------
            EndemeDefinition list1 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false)      , true ));  // must have both A and B
            r = Assert.That(list1.Count, Is.equal_to, 1);
            r = Assert.That(list1[0].Item.StrValue, Is.equal_to, "For Dinner"   );


            EndemeDefinition list2 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false)      , false));  // include all items, order by number of A and B
            ...
            EndemeDefinition list3 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 1, 2, true ));  // must have at least 1 of A and B, then order by number of A and B
            ...
            EndemeDefinition list4 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 0, 2, true));  // include all items, order by number of A and B
            ...
            EndemeDefinition list5 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 0, 1, true));  // include all items, order by number of A and B
            ...
            EndemeDefinition list6 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 2   , true));  // include all items, order by number of A and B
            r = Assert.That(list6.Count, Is.equal_to, 1);
            r = Assert.That(list6[0].Item.StrValue, Is.equal_to, "For Dinner"   );


            EndemeDefinition list7 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 1   , true));  // include all items, order by number of A and B
            r = Assert.That(list7.Count, Is.equal_to, 1);
            r = Assert.That(list7[0].Item.StrValue, Is.equal_to, "For Breakfast");


            EndemeDefinition list8 = field.By(new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "AB", false), 0   , true));  // include all items, order by number of A and B
            r = Assert.That(     list8.Count, Is.equal_to, 1);
            r = Assert.That(     list8[0].Item.StrValue, Is.equal_to, "For Lunch"    );


            EndemeActuator    act9 = new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "A", false), true).HasChars(new Endeme(Fruits, "CD", false), true);
            ...
            EndemeActuator    act10 = new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "A", false)).HasChars(new Endeme(Fruits, "CD", false));
            ...
            EndemeActuator    act11 = new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "A", false), false).HasChars(new Endeme(Fruits, "CD", false), false);
            ...
            EndemeActuator act12 = new EndemeActuator().HasChars(new Endeme(WetlandAnimals, "A", false));
          //act12.HasChars[0].
        ...
        public void EndemeActuator_HasValue_test()
        {
            ...
            prof.Add(new EndemeItem(new Endeme(Fruits, "ABCD", false), new EndemeValue("Punch")));
            prof.Add(new EndemeItem(new Endeme(WetlandAnimals, "ABCD", false), new EndemeValue(7)));
            field.Add(prof, 'f', false);
            ...
            EndemeActuator   act5   = new EndemeActuator()
                .HasValue(new Endeme(Fruits, "ABCD", false), "Punch")
                .HasValue(new Endeme(WetlandAnimals, "ABCD", false), 7);
        ...
        public void EndemeActuator_Multifactor_test()
        {
            ...
            EndemeActuator   act3   = new EndemeActuator()
                .HasValue(new Endeme(WetlandAnimals, "ABCD", false), 7)
                .HasChars(new Endeme(Fruits        , "AB"  , false));
            EndemeDefinition found3 = field.By(act3);
        ...
        public void EndemeActuator_SmokeTest()
        {
            ...
            try
            {
                Endeme en = new Endeme(EndemeTests.WetlandAnimals, "ABC", false);
                EndemeDefinition field = new EndemeDefinition("Hi", null);
                ...
                field.Add(new EndemeProfile(), 1, false);
                Assert.SmokeTest();
            }
            catch { Assert.Crash(); }
        ...
        private void EndemeActuator_Weights_test()
        {
...

            {
                ...
                actABC.AndWeight(new Endeme(Fruits,"ABC", false), 22, 21, 1.0, WeightFormula.FullMedian, 1);
...

            {
                ...
                EndemeActuator act1 = new EndemeActuator()
                    .AndWeight(new Endeme(Fruits,"A", false), 22, 21);
                EndemeDefinition result1 = field.By(act1);


                EndemeActuator act2 = new EndemeActuator()
                    .AndWeight(new Endeme(Fruits,"A", false), 22, 10)
                    .AndWeight(new Endeme(WetlandAnimals, "BARD", false), 22, 21);
                EndemeDefinition result2 = field.By(act2);


                EndemeActuator act3 = new EndemeActuator()
                    .AndWeight(new Endeme(Fruits,"ABC", false), 22, 21);
                EndemeDefinition result3 = field.By(act3);


                EndemeActuator act4 = new EndemeActuator();
                act4.AndWeight(new Endeme(Fruits,"ABC", false), 22, 21, 1.0, WeightFormula.FullMedian, 10);
                EndemeDefinition result4 = field.By(act4);
            }
...

            {
              ...
              //act2.AndWeight(new Endeme(Fruits,"ABCDEFGHIJKLMNOP"), 22, 21, 1.0, WeightFormula.FullMedian, 10);
                act2.AndWeight(new Endeme(Fruits,"ABCDEFGHIJKLMNOP", false), WeightFormula.FullMedian, 10, 1.0);
                EndemeDefinition result2 = simple.By(act2);


                EndemeActuator   act3    = new EndemeActuator().AndWeight(new Endeme(Fruits,"ABCDEFGH", false), 22, 21, 1.0, WeightFormula.FullMedian, 10);
                EndemeDefinition result3 = simple.By(act3);
                Assert.That(result3[0].ItemProfile[0].ItemEndeme.ToString(), Is.equal_to, "ABCDEFGH");


                EndemeActuator act4 = new EndemeActuator();
                act4.AndWeight(new Endeme(Fruits,"ABCDEFGHIJKLMNOPQRSTUV", false), 22, 21, 1.0, WeightFormula.FullMedian, 10);
...

            {
                ...
                act.AndWeight(new Endeme(Fruits,"A", false), 22, 21, 1.0, WeightFormula.FullMedian, 10);
...

            {
                ...
                EndemeActuator act = new EndemeActuator();
                act.AndWeight(new Endeme(Fruits,"A", false), 22, 21, 1.0, WeightFormula.FullMedian);
                EndemeDefinition result = field.By(act);
        ...
        private void EndemeDefinition_By_Weight_test()
        {
          ...
          //Result r = null;
            ...
            EndemeActuator act = new EndemeActuator();
            act.AndWeight(new Endeme(TinyEndemeSet,"AB", false), 22, 21, 1.0, WeightFormula.FullMedian, 7);
            EndemeDefinition result = field.By(act);
        ...
        public void EndemeList_test()
        {
            ...
            field[new EndemeTermKey("Animal:LR")] = new EndemeItem("ABC");
            field[new EndemeTermKey("Animal:A" )] = new EndemeItem(42);
            field[new EndemeTermKey("Animal:LR")] = new EndemeItem("DEF");
            int    age  = 0;
            string code = "";
            try
            {
                age  = (int)   field[new EndemeTermKey("Animal:A" )].Item.Value;
                code = (string)field[new EndemeTermKey("Animal:LR")].Item.Value;
            }
            catch (Exception ex)
            {
                Assert.Crash(ex);
        ...
        public void EndemeList_OrderBy_test()
        {
            ...
            list.Add("Item A", "ABC", null, false);
            list.Add("Item B", "DEF", null, false);
        ...
        public void EndemeList_Add_test()
        {
            ...
            EndemeList list = new EndemeList("Wetland animals", WetlandAnimals);
            list.Add("hiworld", "ABC", null, false);
        ...
        public void EndemeProfile_Constructor_test()
        {
            ...
            path = new EndemeProfile("Animal:ABC*Fruit:DEF", enRef);            Assert.That(path.ToString(), Is.equal_to, "Animal:ABC*Fruit:DEF");
            path = new EndemeProfile("Job:ABC+Identity:FL" , enRef);            Assert.That(path.ToString(), Is.equal_to, "Job:ABC+Identity:FL");
            path = new EndemeProfile("Job:ABC!Identity:FL" , null );            Assert.That(path.ToString(), Is.equal_to, "Job:ABC!Identity:FL");
            path = new EndemeProfile("Animal:ABC"          , enRef);            Assert.That(path.ToString(), Is.equal_to, "Animal:ABC");
        ...
        /// 
        /// </summary>
        public void EndemeFormat_Show_test()
        {
            Assert.ThingsAbout("EndemeFormat", "Show");


            Endeme endeme = new Endeme(WetlandAnimals, "MKACLENSJHUFIGBVTQDPOR", false);
            string str = "";
            str = EndemeFormat.Show_complex(endeme, 27, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU-FIGB-VTQD-POR"); // perfect, common
            str = EndemeFormat.Show_complex(endeme, 27, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIGB-VTQD-POR ");
            str = EndemeFormat.Show_complex(endeme, 27, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIGB-VTQDPOR  ");
            str = EndemeFormat.Show_complex(endeme, 27, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGB-VTQDPOR   ");
            str = EndemeFormat.Show_complex(endeme, 27, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGBVTQDPOR    ");
            str = EndemeFormat.Show_complex(endeme, 27, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR     ");
            str = EndemeFormat.Show_complex(endeme, 26, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIG--VTQD-POR");
            str = EndemeFormat.Show_complex(endeme, 26, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIGB-VTQD-POR"); // perfect, common
            str = EndemeFormat.Show_complex(endeme, 26, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIGB-VTQDPOR ");
            str = EndemeFormat.Show_complex(endeme, 26, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGB-VTQDPOR  ");
            str = EndemeFormat.Show_complex(endeme, 26, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGBVTQDPOR   ");
            str = EndemeFormat.Show_complex(endeme, 26, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR    ");
            str = EndemeFormat.Show_complex(endeme, 25, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI--VTQD-POR");
            str = EndemeFormat.Show_complex(endeme, 25, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIG-VTQD-POR");
            str = EndemeFormat.Show_complex(endeme, 25, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIGB-VTQDPOR"); // perfect
            str = EndemeFormat.Show_complex(endeme, 25, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGB-VTQDPOR ");
            str = EndemeFormat.Show_complex(endeme, 25, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGBVTQDPOR  ");
            str = EndemeFormat.Show_complex(endeme, 25, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR   ");
            str = EndemeFormat.Show_complex(endeme, 24, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI--TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 24, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI-VTQD-POR");
            str = EndemeFormat.Show_complex(endeme, 24, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFIG-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 24, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGB-VTQDPOR"); // perfect, common
            str = EndemeFormat.Show_complex(endeme, 24, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGBVTQDPOR ");
            str = EndemeFormat.Show_complex(endeme, 24, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR  ");
            str = EndemeFormat.Show_complex(endeme, 23, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUF--TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 23, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI-TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 23, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 23, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIG-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 23, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFIGBVTQDPOR"); // perfect
            str = EndemeFormat.Show_complex(endeme, 23, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR ");
            str = EndemeFormat.Show_complex(endeme, 22, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU--TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 22, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUF-TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 22, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUFI-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 22, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFI-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 22, 1, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIG-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 22, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGBVTQDPOR"); // perfect
            str = EndemeFormat.Show_complex(endeme, 21, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU--QD-POR");
            str = EndemeFormat.Show_complex(endeme, 21, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU-TQD-POR");
            str = EndemeFormat.Show_complex(endeme, 21, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHUF-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 21, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUFI-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 21, 1, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFI-VTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 21, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIGVTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 20, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJH--QD-POR");
            str = EndemeFormat.Show_complex(endeme, 20, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU-QD-POR");
            str = EndemeFormat.Show_complex(endeme, 20, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJHU-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 20, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHUF-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 20, 1, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFI-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 20, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFIVTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 18, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJ--D-POR");
            str = EndemeFormat.Show_complex(endeme, 18, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJ-QD-POR");
            str = EndemeFormat.Show_complex(endeme, 18, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-SJH-QDPOR");
            str = EndemeFormat.Show_complex(endeme, 18, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJHU-QDPOR");
            str = EndemeFormat.Show_complex(endeme, 18, 1, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHU-TQDPOR");
            str = EndemeFormat.Show_complex(endeme, 18, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHUFTQDPOR");
            str = EndemeFormat.Show_complex(endeme, 15, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN----POR");
            str = EndemeFormat.Show_complex(endeme, 15, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN--D-POR");
            str = EndemeFormat.Show_complex(endeme, 15, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN-S-DPOR");
            str = EndemeFormat.Show_complex(endeme, 15, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN-SJ-DPOR");
            str = EndemeFormat.Show_complex(endeme, 15, 1, "-");  Assert.That(str, Is.equal_to, "MKACLENSJ-QDPOR");
            str = EndemeFormat.Show_complex(endeme, 15, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSJHQDPOR");
            str = EndemeFormat.Show_complex(endeme, 12, 5, "-");  Assert.That(str, Is.equal_to, "MKA-CL----OR");
            str = EndemeFormat.Show_complex(endeme, 12, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CL---POR");
            str = EndemeFormat.Show_complex(endeme, 12, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CLE--POR");
            str = EndemeFormat.Show_complex(endeme, 12, 2, "-");  Assert.That(str, Is.equal_to, "MKACLEN--POR");
            str = EndemeFormat.Show_complex(endeme, 12, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-DPOR");
            str = EndemeFormat.Show_complex(endeme, 12, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENSDPOR");
            str = EndemeFormat.Show_complex(endeme, 11, 5, "-");  Assert.That(str, Is.equal_to, "MKA-C----OR");
            str = EndemeFormat.Show_complex(endeme, 11, 4, "-");  Assert.That(str, Is.equal_to, "MKA-CL---OR");
            str = EndemeFormat.Show_complex(endeme, 11, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CL--POR");
            str = EndemeFormat.Show_complex(endeme, 11, 2, "-");  Assert.That(str, Is.equal_to, "MKACLE--POR");
            str = EndemeFormat.Show_complex(endeme, 11, 1, "-");  Assert.That(str, Is.equal_to, "MKACLEN-POR"); // common
            str = EndemeFormat.Show_complex(endeme, 11, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENDPOR");
            str = EndemeFormat.Show_complex(endeme, 10, 5, "-");  Assert.That(str, Is.equal_to, "MKA-----OR");
            str = EndemeFormat.Show_complex(endeme, 10, 4, "-");  Assert.That(str, Is.equal_to, "MKA-C---OR");
            str = EndemeFormat.Show_complex(endeme, 10, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CL--OR");
            str = EndemeFormat.Show_complex(endeme, 10, 2, "-");  Assert.That(str, Is.equal_to, "MKACL--POR");
            str = EndemeFormat.Show_complex(endeme, 10, 1, "-");  Assert.That(str, Is.equal_to, "MKACLE-POR");
            str = EndemeFormat.Show_complex(endeme, 10, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENPOR");
            // phase change here from endeme, a 33% low, 67% high approach to 100% high
            str = EndemeFormat.Show_complex(endeme,  8, 5, "-");  Assert.That(str, Is.equal_to, "MKA-----");
            str = EndemeFormat.Show_complex(endeme,  8, 4, "-");  Assert.That(str, Is.equal_to, "MKA-C---");
            str = EndemeFormat.Show_complex(endeme,  8, 3, "-");  Assert.That(str, Is.equal_to, "MKA-CL--");
            str = EndemeFormat.Show_complex(endeme,  8, 2, "-");  Assert.That(str, Is.equal_to, "MKA-CLE-");
            str = EndemeFormat.Show_complex(endeme,  8, 1, "-");  Assert.That(str, Is.equal_to, "MKA-CLEN"); // common
            str = EndemeFormat.Show_complex(endeme,  8, 0, "-");  Assert.That(str, Is.equal_to, "MKACLENS");
            str = EndemeFormat.Show_complex(endeme,  7, 5, "-");  Assert.That(str, Is.equal_to, "MK-----" );
            str = EndemeFormat.Show_complex(endeme,  7, 4, "-");  Assert.That(str, Is.equal_to, "MKA----" );
            str = EndemeFormat.Show_complex(endeme,  7, 3, "-");  Assert.That(str, Is.equal_to, "MKA-C--" );
            str = EndemeFormat.Show_complex(endeme,  7, 2, "-");  Assert.That(str, Is.equal_to, "MKA-CL-" );
            str = EndemeFormat.Show_complex(endeme,  7, 1, "-");  Assert.That(str, Is.equal_to, "MKA-CLE" );
            str = EndemeFormat.Show_complex(endeme,  7, 0, "-");  Assert.That(str, Is.equal_to, "MKACLEN" ); // common
            str = EndemeFormat.Show_complex(endeme,  5, 5, "-");  Assert.That(str, Is.equal_to, "-----"   );
            str = EndemeFormat.Show_complex(endeme,  5, 4, "-");  Assert.That(str, Is.equal_to, "M----"   );
            str = EndemeFormat.Show_complex(endeme,  5, 3, "-");  Assert.That(str, Is.equal_to, "MK---"   );
            str = EndemeFormat.Show_complex(endeme,  5, 2, "-");  Assert.That(str, Is.equal_to, "MKA--"   );
            str = EndemeFormat.Show_complex(endeme,  5, 1, "-");  Assert.That(str, Is.equal_to, "MKA-C"   );
            str = EndemeFormat.Show_complex(endeme,  5, 0, "-");  Assert.That(str, Is.equal_to, "MKACL"   );
            str = EndemeFormat.Show_complex(endeme,  3, 5, "-");  Assert.That(str, Is.equal_to, "---"     );
            str = EndemeFormat.Show_complex(endeme,  3, 4, "-");  Assert.That(str, Is.equal_to, "---"     );
            str = EndemeFormat.Show_complex(endeme,  3, 3, "-");  Assert.That(str, Is.equal_to, "---"     );
            str = EndemeFormat.Show_complex(endeme,  3, 2, "-");  Assert.That(str, Is.equal_to, "M--"     );
            str = EndemeFormat.Show_complex(endeme,  3, 1, "-");  Assert.That(str, Is.equal_to, "MK-"     );
            str = EndemeFormat.Show_complex(endeme,  3, 0, "-");  Assert.That(str, Is.equal_to, "MKA"     ); // common
            str = EndemeFormat.Show_complex(endeme,  1, 5, "-");  Assert.That(str, Is.equal_to, "-"       );
            str = EndemeFormat.Show_complex(endeme,  1, 4, "-");  Assert.That(str, Is.equal_to, "-"       );
            str = EndemeFormat.Show_complex(endeme,  1, 3, "-");  Assert.That(str, Is.equal_to, "-"       );
            str = EndemeFormat.Show_complex(endeme,  1, 2, "-");  Assert.That(str, Is.equal_to, "-"       );
            str = EndemeFormat.Show_complex(endeme,  1, 1, "-");  Assert.That(str, Is.equal_to, "-"       );
            str = EndemeFormat.Show_complex(endeme,  1, 0, "-");  Assert.That(str, Is.equal_to, "M"       );
            str = EndemeFormat.Show_complex(endeme,  0, 5, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme,  0, 4, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme,  0, 3, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme,  0, 2, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme,  0, 1, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme,  0, 0, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 5, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 4, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 3, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 2, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 1, "-");  Assert.That(str, Is.equal_to, ""        );
            str = EndemeFormat.Show_complex(endeme, -1, 0, "-");  Assert.That(str, Is.equal_to, ""        );
    ...
    public class EndemeMatchTest
    {
        ...
        {
            Endeme en1 = new Endeme(EndemeSet.WetlandAnimals, Endeme1, false);
            Endeme en2 = new Endeme(EndemeSet.WetlandAnimals, Endeme2, false);
    ...
    public class EndemeTestItem
    {
	    ...
	    {
		    Endeme1 = new Endeme(EndemeSet.WetlandAnimals, en1, false);
		    Endeme2 = new Endeme(EndemeSet.WetlandAnimals, en2, false);
		    TgtRank = rank;
            SrcRank = 0;
            Result  = 0.0;
	    }
        ...
        public static string CalculateTable(Dictionary<string, EndemeTestItem> test)
        {
            ...
            foreach (KeyValuePair<string, EndemeTestItem> item in sortedDict)
            {
                ...
                diff += delim + Math.Abs(val.TgtRank - val.SrcRank).ToString().PadLeft(2)
                    ...
                    + "  '" + (val.Endeme1.ToString() + "'").PadLeft(25) + " v '" + val.Endeme2 + "'";
                delim = "\r\n";
            }
