...
namespace InfoLib.Data
{
    ...
    public class RichXmlDoc
    {
        ...
        //  Constructors
        // ----------------------------------------------------------------------------------------
        public RichXmlDoc()                 { _doc = new XmlDocument();                     }
        public RichXmlDoc(XmlDocument xdoc) { _doc = xdoc;                                  }
        public RichXmlDoc(string xdoc)
        {
            LoadXml(xdoc);
        }
        ...
        /// </summary>
        /// <returns></returns>
        public RichXmlDoc _Copy()
        {
            RichXmlDoc rx = new RichXmlDoc(_doc.OuterXml);
        ...
        {
            string    str  = StrValue(xPath, "");
            DateTime? time = TreatAs.DateValue(str, defaultValue);
            return    time;
        }
