...
//--------------------------------------------------------------------------------------------------
using InfoLib.HardData;               // for ResistSqlInjection, SqlQueryWithDeclaredParameters
using InfoLib.Endemes ;               // for Endeme, EndemeSet
using InfoLib.SoftData;               // for TreatAs
using InfoLib.Strings ;               // for __.ConcatIf
...
namespace InfoLib.Data
{
    ...
    public sealed class RichSqlCommand
    {
        ...
        public RichSqlCommand(                  string        conn                      , string        query                                  ) { Init(CommandType.Text, ConnectSource.Connection(conn), "P"   , query           ); } ///<summary>Instantiates a RichSqlCommand object to run a text command or a stored procedure</summary><param name="commandType">generally either .Text or .StoredProcedure, this hasn't been tested for .TableDirect</param><param name="conn">the connection in the form of either a connnection string, connnection string configuraiton file label, or existing connection</param><param name="query">the query in the form of either a string or a StringBuilder</param><param name="actions">a set of options for when things go wrong</param><param name="action">actual actions to take if things go wrong</param>
        ...
        public RichSqlCommand(                                                                                                                 ) { InitVariables();                 InitMessages(); _exceptionAction = "NPL" ;       }
        public RichSqlCommand(SqlCommand  cmd                                                                , EndemeSet actions, Endeme action) { InitVariables(); _command = cmd; InitMessages(); _exceptionAction = action;       }
        ...
        public  RichSqlCommand _AddParameter_safe  (string name, string      value                        ) { if (value == null) AddParameter(name, SqlString.Null, SqlDbType.VarChar); else { AddParameter(name, InData.ResistSqlInjection(value, 0     ), SqlDbType.VarChar        ); } return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_safe  (string name, string      value, int maxLen            ) { if (value == null) AddParameter(name, SqlString.Null, SqlDbType.VarChar); else { AddParameter(name, InData.ResistSqlInjection(value, maxLen), SqlDbType.VarChar, maxLen); } return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_safe  (string name, string      value, ParameterDirection dir) { if (value == null) AddParameter(name, SqlString.Null, SqlDbType.VarChar); else { AddParameter(name, InData.ResistSqlInjection(value, 0     ), SqlDbType.VarChar, dir   ); } return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_safe  (string name, SqlString   value                        ) { SqlString safer = SqlString.Null; if (!value.IsNull) safer = InData.ResistSqlInjection(value.ToString(), 0     );   AddParameter(name, safer, SqlDbType.VarChar        );   return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_safe  (string name, SqlString   value, int maxLen            ) { SqlString safer = SqlString.Null; if (!value.IsNull) safer = InData.ResistSqlInjection(value.ToString(), maxLen);   AddParameter(name, safer, SqlDbType.VarChar        );   return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_safe  (string name, SqlString   value, ParameterDirection dir) { SqlString safer = SqlString.Null; if (!value.IsNull) safer = InData.ResistSqlInjection(value.ToString(), 0     );   AddParameter(name, safer, SqlDbType.VarChar, dir   );   return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        public  RichSqlCommand _AddParameter_unsafe(string name, string      value                        ) {                                                                                                                     AddParameter(name, value, SqlDbType.VarChar        );   return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary><remarks>test me</remarks>
        public  RichSqlCommand _AddParameter_unsafe(string name, string      value, ParameterDirection dir) {                                                                                                                     AddParameter(name, value, SqlDbType.VarChar, dir   );   return this; } /// <summary>Safer string Parameter adding (resists Sql Injection)</summary>
        private RichSqlCommand _AddParameter_sized (string name, SqlDbType   type , object value, int size) { SqlParameter sp = new SqlParameter(name, type); sp.Value = value; sp.Direction = ParameterDirection.Input; sp.Size = size; _command.Parameters.Add(sp); return this; }
        ...
        public RichSqlCommand _AddParameter     (string name, bool        value, ParameterDirection dir) { SqlParameter sp = new SqlParameter(name, SqlDbType.Bit             );                                                  sp.Value = value; sp.Direction = dir                     ; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, value and direction</summary>
        public RichSqlCommand _AddParameter     (string name, bool        value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Bit             );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, bool?       value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Bit             ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_byte(string name, byte[]      value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.VarBinary       ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
      //public RichSqlCommand _AddParameter_safe(string name, char        value   /* needed? */        ) { char      safer = ' '           ; if (value != null) { safer = value; } AddParameter_sized(name, SqlDbType.VarChar, safer, 1); return this; } 
        public RichSqlCommand _AddParameter_char(string name, char        value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Char            );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_char(string name, char        value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_char(string name, char        value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_char(string name, char?       value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Char            ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, DateTime    value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
        public RichSqlCommand _AddParameter     (string name, DateTime    value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
        public RichSqlCommand _AddParameter_date(string name, DateTime?   value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_date(string name, DateTime?   value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, Guid        value, ParameterDirection dir) { SqlParameter sp = new SqlParameter(name, SqlDbType.UniqueIdentifier); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = dir                     ; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, Guid        value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.UniqueIdentifier); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, Guid?       value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.UniqueIdentifier); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, SqlDateTime value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
        public RichSqlCommand _AddParameter     (string name, SqlDateTime value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
                                                                                                                                                                                                                                                                                                                                        /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, decimal     value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
        public RichSqlCommand _AddParameter     (string name, decimal     value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, SqlDbType and value</summary>
        public RichSqlCommand _AddParameter_null(string name, decimal?    value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Decimal         ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, double      value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, double      value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, double?     value                        ) { SqlParameter sp = new SqlParameter(name,    DbType.Double          ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, float       value,    DbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, float       value, SqlDbType type        ) { SqlParameter sp = new SqlParameter(name, type                      );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, float?      value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Float           ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, int         value, ParameterDirection dir) { SqlParameter sp = new SqlParameter(name, SqlDbType.Int             );                                                  sp.Value = value; sp.Direction = dir                     ; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, value and direction</summary>
        public RichSqlCommand _AddParameter     (string name, int         value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Int             );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, int?        value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.Int             ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, long        value, ParameterDirection dir) { SqlParameter sp = new SqlParameter(name, SqlDbType.BigInt          );                                                  sp.Value = value; sp.Direction = dir                     ; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, value and direction</summary>
        public RichSqlCommand _AddParameter     (string name, long        value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.BigInt          );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, long?       value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.BigInt          ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter     (string name, short       value, ParameterDirection dir) { SqlParameter sp = new SqlParameter(name, SqlDbType.SmallInt        );                                                  sp.Value = value; sp.Direction = dir                     ; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name, value and direction</summary>
        public RichSqlCommand _AddParameter     (string name, short       value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.SmallInt        );                                                  sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        public RichSqlCommand _AddParameter_null(string name, short?      value                        ) { SqlParameter sp = new SqlParameter(name, SqlDbType.SmallInt        ); if (value == null) sp.Value = DBNull.Value; else sp.Value = value; sp.Direction = ParameterDirection.Input; _command.Parameters.Add(sp); return this; } /// <summary>Adds a parameter of the specified name and value</summary>
        ...
        /// </summary>
        /// <returns></returns>
        public EndemeList ExecuteEndemeLister()
        {
            RichDataTable table = new RichDataTable(this, "", "EndemeId, EndemeCharLetter");
            EndemeList enList = new EndemeList("Anonymous", null);
            if (table.Count > 1 && table.IntValue(0, "EndemeId", -1) > -1)
            {
                // ----------------------------------------------------------------------
                ...
                {
                    Guid rowEnSetId  = table.GuidValue(row, "EndemeSetId", Guid.Empty);
                    long rowEndemeId = table.LongValue(row, "EndemeId", -1);


                    if (rowEnSetId != enSetId || rowEndemeId != endemeId)
                    {
                        // --------------------------------------------------------------
                        //  Start the endeme/set
                        // --------------------------------------------------------------
                        enSet = new EndemeSet(rowEnSetId
                            , table.StrValue (row, "EndemeSetLabel", ""));
                        en = new Endeme(enSet
                            , table.StrValue (row, "EndemeString", "")
                            , table.BoolValue(row, "RawSource", false));


                        // --------------------------------------------------------------
                        //  Put it in the list
                        // --------------------------------------------------------------
                        string    text = table.StrValue (row, "ValueText"  , null);
                        decimal?  num  = table.DecValue (row, "ValueNumber"      );
                        double?   real = table.RealValue(row, "ValueFloat"       );
                        DateTime? date = table.DateValue(row, "ValueDateTime"    );
                        byte[]    bin  = table.ByteValue(row, "ValueBinary", null);


                        EndemeValue enValue = new EndemeValue(table.StrValue (row, "ValueText", ""));

                        EndemeItem enItem = new EndemeItem(endemeId, en, table.StrValue (row, "ValueText", ""));
                        ...
                        // --------------------------------------------------------------
                        enSetId  = enSet.EndemeSetId;
                        endemeId = rowEndemeId;
                    }
                    ...
                    // ------------------------------------------------------------------
                    enSet.Add
                        ( table.CharValue(row, "EndemeCharLetter", '\0')
        ...
        public DateTime? ExecuteScalar(DateTime? dflt) { object obj = ExecuteScalar(dflt, DateTime.Now); if (obj == null) return dflt; else return TreatAs.DateValue(obj, dflt); }
        public Endeme    ExecuteScalar(Endeme    dflt) { object obj = ExecuteScalar(dflt, DateTime.Now); if (obj == null) return dflt; else return new Endeme(obj.ToString(), false); }
        ...
        /// <!-- InitMessages -->
        /// <summary>
        ///      Dependency: requires the command's connection object instantiated first
        /// </summary>
        /// <remarks>production ready - please test me</remarks>
        private void InitMessages()
        {
            ...
            if (_command.Connection == null)
                throw new ArgumentNullException("RichSqlCommand._InitMessages error - Null connection not allowed when setting up connection events");
