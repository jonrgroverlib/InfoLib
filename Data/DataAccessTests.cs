...
using InfoLib.HardData;        // for ConnectionSource
using InfoLib.Strings ;        // for __.IsNull
...
namespace InfoLib.Data
{
	...
	public class DataAccessTests
	{
        ...
        public void TestJson_Deserialization_test()
        {
            ...
            Endeme               en      = new Endeme(enSet, "JON GROVER", true); en.Quant.Raw['B'] = 2;
        ...
        /// <!-- RichSqlCommand_AddParameter_test -->
        /// <summary>
        ///      Tests the RichSqlCommand._AddParameter method
		/// </summary>
		/// <remarks></remarks>
		///[Test]
		public void RichSqlCommand_AddParameter_test()
		{
			...
			RichSqlCommand cmd = new RichSqlCommand(CommandType.StoredProcedure, _conn
                , "SELECT * FROM Students WITH(NOLOCK) WHERE StudentID = @StudentID"
                , Throws.Actions, "HIPLANET")
                ._AddParameter("@StudentID", 3);
