...
//--------------------------------------------------------------------------------------------------
using InfoLib.Data    ;               // for 
using InfoLib.SoftData;               // for 
...
namespace InfoLib.Generator
{
    ...
    /// </remarks>
    public abstract class AbstractXmlGenerator : IHaveGeneratorResults
    {
        ...
        // ----------------------------------------------------------------------------------------
        /// <!-- NewXml -->
        private RichXmlDoc _newXml;
        /// <summary>
        ///      The Xml thus created
        /// </summary>
        public RichXmlDoc NewXml
        {
            get { return _newXml; }
        ...
        public string Create(string schemaFilePath)
        {
            ...
            string xml = CreateFrom(__.LastSegment(schemaFilePath));
        ...
        private string CreateFrom(string fileName)
        {
            ...
            // --------------------------------------------------------------------------
            string pretty = PrettyTraversal_manager(new RichXmlDoc(schema.XmlDocument));
        ...
        /// <returns></returns>
        public static string PrettyTraversal_manager(RichXmlDoc xml)
        {
