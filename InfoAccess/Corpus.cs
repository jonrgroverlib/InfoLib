...
//--------------------------------------------------------------------------------------------------
using InfoLib.HardData;               // for 
using InfoLib.Testing ;               // for IHaveListMembers
using System          ;               // for 
...
namespace InfoLib.Info
{
    ...
    public class Corpus : IHaveListMembers
    {
        // ----------------------------------------------------------------------------------------
        ...
        public         FileGroup CorpusGroup     { get;         set; }
        ...
        // ----------------------------------------------------------------------------------------
        //  Constructor
        /* ------------------------------------------------------------------------------------- */ /// <param name="corpusPath">root path or file name</param>
        public Corpus(string corpusPath, string extension, string displayName, int contentStartCol, int contentStartIdx)
        {
            // --------------------------------------------------------------------------
            //  1. Read the corpus
            // --------------------------------------------------------------------------
        ...
        // ----------------------------------------------------------------------------------------
        public        int          Capacity                                        { get { return _lines.Length; } set { throw new NotImplementedException(); } }
        public        int          Count                                           { get { if (_lines != null) return _lines.Length; else return 0; } }
        public        void         Clear              ()                                 { _lines = null; _metaData = null; _content = null; _wordTally = null; _regularWord = null; _properNoun = null; }
        ...
        public bool Contains(string str)
        {
            ...
            {
                if (Regex.IsMatch(FullLine[i], str))
                    return true;
            }
            return contains;
        }
        ...
        /// <!-- SplitCorpus -->
        /// <summary>
        ///      Reads the corpus and divides it into lines
        /// </summary>
        /// <returns></returns>
        private string[] SplitCorpus()
        {
            string[] line = null;
            string doc = FilesIO.GetStringFromFile(CorpusPath, "");
