...
namespace InfoLib.HardData // THIS NAMESPACE IS A PRIMITIVE!  use only System.* or InfoLib.Testing references
{
    ...
    public static class ConnectSource
    {
        // ----------------------------------------------------------------------------------------
        // ----------------------------------------------------------------------------------------
        public static string DataBaseFrom(string conn) { return new SqlConnectionStringBuilder(conn).InitialCatalog; }
        public static string ServerFrom  (string conn) { return new SqlConnectionStringBuilder(conn).DataSource;     }
