...
using InfoLib.Endemes ;               // for Throws
using InfoLib.SoftData;               // for TreatAs,TimeDate
using InfoLib.Strings ;               // for __.Pluralize, __.A
...
namespace InfoLib.Vertical
{
    ...
    public class CommonDataRoutine
    {
        ...
        private static RichDataTable FindDsmCodesLike(string keyword, RichDataTable all)
        {
            ...
            return all.SelectToTable(whereClause);
        }
